...
{
    public abstract class FaksistentWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FaksistentWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FaksistentWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FaksistentDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FaksistentDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FaksistentDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FaksistentDbContext, Task<T>> func)
        {
            T result;
