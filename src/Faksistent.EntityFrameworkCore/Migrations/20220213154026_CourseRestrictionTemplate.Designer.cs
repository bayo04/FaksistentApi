...
namespace Faksistent.Migrations
{
    ...
    [Migration("20220213154026_CourseRestrictionTemplate")]
    partial class CourseRestrictionTemplate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Faksistent.Courses.CoursePartition", b =>
                {
                    ...
                    b.Property<int>("AllowedAbsencesWithStimulation")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CoursePartition");
                });

            modelBuilder.Entity("Faksistent.Courses.CourseRestriction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("PointsForPass")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PointsForSignature")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Faksistent.Courses.CourseRestrictionTest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CourseRestrictionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CourseRestrictionId");

                    b.HasIndex("CourseTestId");

                    b.ToTable("CourseRestrictionTests");
                });

            modelBuilder.Entity("Faksistent.Courses.CourseTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Faksistent.Courses.CourseTest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Faksistent.Semesters.SemesterCourse", b =>
                {
                    ...
                    b.Property<Guid>("UserSemesterId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Faksistent.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Faksistent.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Faksistent.Courses.CourseRestrictionTest", b =>
                {
                    b.HasOne("Faksistent.Courses.CourseRestriction", "CourseRestriction")
                        .WithMany("Tests")
                        .HasForeignKey("CourseRestrictionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("CourseRestriction");
