...
namespace Faksistent.Migrations
{
    ...
    [Migration("20220128225239_UserSemesters")]
    partial class UserSemesters
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Faksistent.Semester.UserSemester", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Faksistent.Semester.UserSemester", b =>
                {
                    b.HasOne("Faksistent.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
